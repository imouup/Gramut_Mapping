...
if __name__ == "__main__":
      ...
      # ckpt_path = "models/Q2/oss/20250524_151245.pth"  # 模型路径
      # ### 映射
      # pjt_mlp_flags, loss_mlp = project(ckpt_path, proj_pts, MLP_withflags)  # 越界点的五基色坐标
      # ### 求moss
      # #### 只有MLP的loss
      ...
      # pjt_mlp,loss_mlp = project(ckpt_path, proj_pts,MLP_oss_only) # 越界点的五基色坐标
      # ### 求moss
      # #### 求最小二乘法的loss
